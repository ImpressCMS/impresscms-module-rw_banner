...
switch ($op){
    ...
    case 'mudastatus':
        ...
        if ($banner->mudaStatus())
          redirect_header('index.php',2,_ADM_MSG1);
        else
    ...
    case 'deletar':
        $id = (isset($_GET['id']))?$_GET['id']:'';
        xoops_cp_header();
        xoops_confirm(array( 'id' => $id, 'op'=>'deletar_ok'),'index.php', _ADM_MSG19);
        xoops_cp_footer();
        break;
    case 'deletar_ok':
        ...
        $banner = new RWbanners(null,$id);
        if ($banner->exclui())
          redirect_header('index.php',2,_ADM_MSG101);
        else
          redirect_header('index.php',2,$banner->getError());
        break;
    case 'deletar_categ':
        $id = (isset($_GET['id']))?$_GET['id']:'';
        xoops_cp_header();
        xoops_confirm(array( 'id' => $id, 'op'=>'deletar_categ_ok'),'index.php', _ADM_MSG3);
        xoops_cp_footer();
        break;
    case 'deletar_categ_ok':
        ...
        if ($categ->exclui())
          redirect_header('index.php',2,_ADM_MSG102);
        else
    ...
    case 'deletar_tag':
        $id = (isset($_GET['id']))?$_GET['id']:'';
        xoops_cp_header();
        xoops_confirm(array( 'id' => $id, 'op'=>'deletar_tag_ok'),'index.php', _ADM_MSG20);
        xoops_cp_footer();
        break;
    case 'deletar_tag_ok':
        $id = (isset($_POST['id']))?$_POST['id']:'';
        $tag = new RWTag(null,$id);
        if ($tag->exclui())
          redirect_header('index.php',2,_ADM_MSG21);
        else
          redirect_header('index.php',2,$tag->getError());
        break;
    case 'criardir':
...
function lista_banners($order=null,$seq=null,$limit=10,$start=0){
  ...
  <table style="font-size:10px;" width="100%" class="outer">
    <tr class="head">
      <td align="center"><a href="index.php?order=codigo&seq='.$seq.$extra_sel.'">'._ADM_TITLE2.$img_cod.'</a></td>
      <td align="center"><a href="index.php?order=idcliente&seq='.$seq.$extra_sel.'">'._ADM_TITLE3.$img_cli.'</a></td>
      <td align="center"><a href="index.php?order=categoria&seq='.$seq.$extra_sel.'">'._ADM_TITLE4.$img_cat.'</a></td>
      <td align="center"><a href="index.php?order=exibicoes&seq='.$seq.$extra_sel.'">'._ADM_TITLE5.$img_exib.'</a></td>
      <td align="center">'._ADM_TITLE6.'</td>
      <td align="center"><a href="index.php?order=clicks&seq='.$seq.$extra_sel.'">'._ADM_TITLE7.$img_click.'</a></td>
      <td align="center">'._ADM_TITLE39.'</td>
      <td align="center">'._ADM_TITLE8.'</td>
      <td align="center"><a href="index.php?order=data&seq='.$seq.$extra_sel.'">'._ADM_TITLE9.$img_dat.'</a></td>
      <td align="center">'._ADM_TITLE99.'</td>
      <td align="center"><a href="index.php?order=status&seq='.$seq.$extra_sel.'">'._ADM_TITLE10.$img_sts.'</a></td>
  ...
  for ($i = 0; $i <= count($lista_banners)-1; $i++){
    if ($lista_banners[$i]->getStatus() == 1) {
      $status = '<img src="../images/on.gif" width="20" height="20" border="0" alt="'._ADM_BANNER_STATUS1.'" title="'._ADM_BANNER_STATUS1.'">';
      $estilo = '';
      ...
      $status = '<img src="../images/off.gif" width="20" height="20" border="0" alt="'._ADM_BANNER_STATUS2.'" title="'._ADM_BANNER_STATUS2.'">';
    ...
    echo '
      <tr class="'.$class.'" '.$estilo.'>
        ...
        <td align="center"><a href="index.php?op=mudastatus&id='.$lista_banners[$i]->getCodigo().'">'.$status.'</a></td>';
    echo '
        <td align="center" width="10%">
          <a href="javascript:;" onClick="javascript: window.open(\'exibe.php?id='.$lista_banners[$i]->getCodigo().'\',\'editar\',\'width='.($lista_banners[$i]->getLargura()+20).',height='.$lista_banners[$i]->getAltura().',toolbar=no\');"><img src="../images/view.gif" width="20" height="20" border="0" alt="'._ADM_VALUE_BTN2.'" title="'._ADM_VALUE_BTN2.'"></a>
          <a href="inser.php?id='.$lista_banners[$i]->getCodigo().'&op=editar"><img src="../images/edit.gif" width="20" height="20" border="0" alt="'._ADM_VALUE_BTN3.'" title="'._ADM_VALUE_BTN3.'"></a>
          <a href="index.php?id='.$lista_banners[$i]->getCodigo().'&op=deletar"><img src="../images/delete.gif" width="20" height="20" border="0" alt="'._ADM_VALUE_BTN4.'" title="'._ADM_VALUE_BTN4.'"></a>
        </td>
      </tr>';
  }
...
function lista_categs(){
  ...
  for ($i = 0; $i <= count($lista_categs)-1; $i++){
    ...
    echo '
        <td align="center" width="10%">
          <a href="insercateg.php?id='.$lista_categs[$i]->getCod().'&op=editar_categ"><img src="../images/edit.gif" width="20" height="20" border="0" alt="'._ADM_VALUE_BTN6.'" title="'._ADM_VALUE_BTN6.'"></a>
          <a href="index.php?id='.$lista_categs[$i]->getCod().'&op=deletar_categ"><img src="../images/delete.gif" width="20" height="20" border="0" alt="'._ADM_VALUE_BTN7.'" title="'._ADM_VALUE_BTN7.'"></a>
        </td>
      </tr>';
  }
  echo'</table> ';
...
function lista_tags(){
  ...
  <table style="font-size:10px;" width="100%" class="outer">
  <tr class="head">
    <td align="center">'._ADM_TAG_TITLE01.'</td>
    <td align="center">'._ADM_TAG_TITLE02.'</td>
    <td align="center">'._ADM_TAG_TITLE03.'</td>
    <td align="center">'._ADM_TAG_TITLE04.'</td>
    <td align="center">'._ADM_TAG_TITLE19.'</td>
    <td align="center">'._ADM_TAG_TITLE05.'</td>
    <td align="center">'._ADM_TAG_TITLE06.'</td>
    <td align="center">'._ADM_TAG_TITLE07.'</td>
    <td align="center">'._ADM_TITLE11.'</td>
  </tr>
  ';
  $class = "even";
  for ($i = 0; $i <= count($lista_tags)-1; $i++){
    ...
    if ($lista_tags[$i]->getStatus() == 1) {
      $status = '<img src="../images/on.gif" width="20" height="20" border="0" alt="'._ADM_TAG_STATUS1.'" title="'._ADM_TAG_STATUS1.'">';
      $estilo = '';
    } else {
      $status = '<img src="../images/off.gif" width="20" height="20" border="0" alt="'._ADM_TAG_STATUS2.'" title="'._ADM_TAG_STATUS2.'">';
      $estilo = 'style="color:red;"';
    }
    $categ = ($lista_tags[$i]->getCateg() != 0)?$lista_tags[$i]->getTagCategName():_ADM_TAG_TITLE13;
    $mods = ($lista_tags[$i]->getModuleName())?$lista_tags[$i]->getModuleName():_ADM_TAG_TITLE17;
    echo '
      <tr class="'.$class.'" '.$estilo.'>
        ...
        <td align="center"><a href="index.php?op=mudastatus_tag&id='.$lista_tags[$i]->getId().'">'.$status.'</a></td>';
    echo '
        <td align="center" width="10%">
          <a href="insertag.php?id='.$lista_tags[$i]->getId().'&op=editar_tag"><img src="../images/edit.gif" width="20" height="20" border="0" alt="'._ADM_VALUE_BTN6.'" title="'._ADM_VALUE_BTN6.'"></a>
          <a href="index.php?id='.$lista_tags[$i]->getId().'&op=deletar_tag"><img src="../images/delete.gif" width="20" height="20" border="0" alt="'._ADM_VALUE_BTN7.'" title="'._ADM_VALUE_BTN7.'"></a>
        </td>
      </tr>';
  }
  echo'</table> ';
...
function lista_users(){
  ...
  <tr class="head">
    <td align="center">'._ADM_TITLE2.'</td>
    <td align="left">'._ADM_TITLE17.'</td>
    <td align="left">'._ADM_TITLE18.'</td>
    <td align="left">'._ADM_TITLE19.'</td>
    <td align="center">'._ADM_TITLE20.'</td>
    <td align="center">'._ADM_TITLE11.'</td>
  </tr>
  ';
  $class = "even";
    ...
    if ($qtbanners > 0){
      ...
      echo '
        <tr class="'.$class.'">
          ...
          <td align="center">
            <a href="'.XOOPS_URL.'/userinfo.php?uid='.$uid.'" target="_blank"><img src="../images/view.gif" width="20" height="20" border="0" alt="Ver Cliente" title="Ver Cliente"></a>
            <a href="'.XOOPS_URL.'/modules/system/admin.php?fct=users&uid='.$uid.'&op=modifyUser" target="_blank"><img src="../images/edit.gif" width="20" height="20" border="0" alt="Editar Cliente" title="Editar Cliente"></a>
          </td>
        </tr>';
    }
  }
