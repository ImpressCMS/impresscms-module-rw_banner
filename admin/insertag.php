...
switch ($op){
  ...
  case 'editar_tag':
         xoops_cp_header();
         rwbanner_adminMenu('','Editando Tag código: '.$id);
...
function monta_form($value){
  ...
  $title = new XoopsFormText(_ADM_TAG_TITLE09, "form[title]", 50, 255, $form['title']);
  $name1 = new XoopsFormText(_ADM_TAG_TITLE14, "form[name]", 50, 255, $form['name']);
  $name1->setDescription(_ADM_TAG_TITLE15);
  $codbanner = new XoopsFormText(_ADM_TAG_TITLE22, "form[codbanner]", 10, 255, $form['codbanner']);
  $codbanner->setDescription(_ADM_TAG_TITLE23);
  $categ = new XoopsFormSelect(_ADM_TAG_TITLE10, 'form[categ]', $form['categ']);
  ...
  $qtde = new XoopsFormText(_ADM_TAG_TITLE11, "form[qtde]", 10, 255, $form['qtde']);
  $cols = new XoopsFormText(_ADM_TAG_TITLE12, "form[cols]", 10, 255, $form['cols']);

  $obs = new XoopsFormTextArea(_ADM_TAG_TITLE20, "form[obs]", $form['obs']);
  $obs->setDescription(_ADM_TAG_TITLE21);
  
  $status = new XoopsFormSelect(_ADM_TAG_TITLE18, 'form[status]', $form['status']);
