...
function BannersAdmin()
{
    ...
    echo '<tr class="head"><td colspan="4" align="center"><input type="submit" value="Importar"></td><td align="center"><input type="checkbox" id="selall" onClick="Selall(this.checked);"></td></tr>';
    echo "</table></form>";
    xoops_cp_footer();
}
