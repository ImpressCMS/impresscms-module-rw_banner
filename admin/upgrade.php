...
if (is_object($xoopsUser) && $xoopsUser->isAdmin($xoopsModule->mid())){
  ...
  //Checa se a tabela ds banners existe, caso não exista cria.
  ...
  if($errors) {
    ...
    echo _AM_RWBANNER_UPGRADECOMPLETE." - <a href='".XOOPS_URL."/modules/system/admin.php?fct=modulesadmin&op=update&module=rw_banner'>"._AM_RWBANNER_UPDATEMODULE."</a>";
    echo '<p style="text-align:justify;">'._AM_RWBANNER_UPGRADECOMPLETE1.'</p>';
    echo '<PRE>';
    print('
      #######################################################################################
      #### Hack by rw-banner
      #### Cria variável smarty para exibir banner no tema do site
      #######################################################################################
