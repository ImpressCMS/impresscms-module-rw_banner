...
function exibe_dropbanner($options){
  ...
  include_once (XOOPS_ROOT_PATH.'/modules/rw_banner/language/'.$xoopsConfig['language']."/modinfo.php");
  ...
  $block['title'] = _MI_RWBLOCK5_NAME;
  $block['lang_close'] = _MB_TEXT4;
...
function edita_dropbanner($options){
  ...
  $qtde = _MB_OPTION2."&nbsp;<input type='text' name='options[1]' value='".$options[1]."' onchange='javascript:options1.value = this.value;' />";
  $form .= "<br />".$qtde;
  //Quantidade de colunas em que os banners serão exibidos
  $qtde = _MB_OPTION3."&nbsp;<input type='text' name='options[2]' value='".$options[2]."' onchange='javascript:options2.value = this.value;' />";
  $form .= "<br />".$qtde;
  //Tipo de exibição do box.
  $arr = array("1"=>_MB_OPTION16_1,"2"=>_MB_OPTION16_2,"3"=>_MB_OPTION16_3);
  $qtde = _MB_OPTION16."&nbsp;<select options[3] name=\"options[3]\">";
  ...
  $teste = _MB_OPTION17."&nbsp;<input type='text' id='freq' name='options[4]' value='".$options[4]."' />";
  $form .= "<br />".$teste;
  //Direção do "aparecimento" do box
  $arr = array("up"=>_MB_OPTION18_1,"down"=>_MB_OPTION18_2);
  $qtde = _MB_OPTION18."&nbsp;<select options[5] name=\"options[5]\" onchange='javascript:habilita(this.value);'>";
  foreach($arr as $key=>$value){
  ...
  $form .= "<br />".$qtde;
  //Posição esquerda
  $qtde = _MB_OPTION19."&nbsp;<input type='text' name='options[6]' value='".$options[6]."' onchange='javascript:options6.value = this.value;' />";
  $form .= "<br />".$qtde;
  //Posição top
  $qtde = _MB_OPTION20."&nbsp;<input type='text' name='options[7]' value='".$options[7]."' onchange='javascript:options7.value = this.value;' />";
  $form .= "<br />".$qtde;
  //Background
  $qtde = _MB_OPTION21."&nbsp;<input type='text' name='options[8]' value='".$options[8]."' onchange='javascript:options7.value = this.value;' />";
  $form .= "<br />".$qtde;
  $form .= '<br /><br />'._MB_OPTION10;

  include_once XOOPS_ROOT_PATH."/class/xoopsformloader.php";

  $cont = new XoopsFormDhtmlTextArea('','options[9]',$options[9],10);

  $form .= '<br />'.$cont->render().'<br />'._MB_OPTION11;
