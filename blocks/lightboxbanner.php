...
function edita_lightboxbanner($options){
  ...
  $qtde = _MB_OPTION16."&nbsp;<select options[1] name=\"options[1]\">";
  ...
  $teste = _MB_OPTION17."&nbsp;<input type='text' id='freq' name='options[2]' value='".$options[2]."' />";
  $form .= "<br />".$teste;
