...
define('_AM_RWBANNER_NODIR', 'Le r&eacute;pertoire par d&eacute;faut pour les banni&#232;res est inexistant ou inaccessible.<br /><font color="red">R&eacute;pertoire par d&eacute;faut : "%s"</font> <a href="index.php?op=criardir">Cr&eacute;er un r&eacute;pertoire</a>');
