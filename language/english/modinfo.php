...
define('_MI_RWBANNER_DESC', 'System for the management and exhibition of random banners.');
...
define('_MI_RW_DIRIMAGES', 'Banners Dir.:');
define('_MI_RW_DIRIMAGES_DESC', 'Default banner upload directory');
define('_MI_RW_SHOWCADFORM', 'Allow registration:');
...
define('_MI_RWBANNER_MODULE_BUG', 'Repor a bug in this module');
...
define('_ADM_MENU_TITLE2', 'Blocks/Groups');
define('_ADM_MENU_TITLE3', 'Add Banner');
define('_ADM_MENU_TITLE4', 'Add Category');
define('_ADM_MENU_TITLE5', 'Support');
define('_ADM_MENU_TITLE6', 'About the Module');
define('_ADM_MENU_TITLE7', 'Preferences');
define('_ADM_MENU_TITLE8', 'Add Tags');
