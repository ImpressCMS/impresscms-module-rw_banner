...
define("_AM_RWBANNER_NODIR",'A pasta padrão de upload dos banner não existe ou está inacessível.<br /><font color="red">Pasta Padrão: "%s"</font> <a href="index.php?op=criardir">Criar Pasta</a>');
