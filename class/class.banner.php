...
// ------------------------------------------------------------------------- //
include_once XOOPS_ROOT_PATH."/modules/rw_banner/include/functions.php";
...
class RWbanners {
    ...
    //Construtor
	function RWbanners($dados=null, $id = null)
	{
      ...
      for($i = 0; $i <= count($arr)-1; $i++){
        ...
        if ($arr[$i]->getUsarhtml() == 1){
          ...
          if ($arr[$i]->getUrl() == '' || $arr[$i]->getUrl() == '#')
            ...
            $bannerobject = '<div align="'.$align.'"><a href="'.XOOPS_URL.'/modules/rw_banner/conta_click.php?id='.$arr[$i]->getCodigo().'" target="'.$arr[$i]->getTarget().'">';
          if (stristr($arr[$i]->getGrafico(), '.swf')) {
            ...
            .'<PARAM NAME=FlashVars VALUE="alt='.$arr[$i]->getAltura().'&larg='.$arr[$i]->getLargura().'&fps='.$fps.'&banner='.$arr[$i]->getGrafico().'&id='.$arr[$i]->getCodigo().'&url='.XOOPS_URL.'/modules/rw_banner&target='.$arr[$i]->getTarget().'">'
            .'<embed src="'.XOOPS_URL.'/modules/rw_banner/images/rwbanner.swf" FlashVars="alt='.$arr[$i]->getAltura().'&larg='.$arr[$i]->getLargura().'&fps='.$fps.'&banner='.$arr[$i]->getGrafico().'&id='.$arr[$i]->getCodigo().'&url='.XOOPS_URL.'/modules/rw_banner&target='.$arr[$i]->getTarget().'" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash"; type="application/x-shockwave-flash" width="'.$arr[$i]->getLargura().'" height="'.$arr[$i]->getAltura().'">'
            .'</embed>'
            .'</object></div>';
          }else{
      ...
      $showban = '<table border="0" cellpadding="0" cellspacing="5"><tr>';
        if ($ban->getUsarhtml() == 1){
          ...
          if ($ban->getUrl() == '' || $ban->getUrl() == '#')
            ...
            $bannerobject = '<div align="'.$align.'"><a href="'.XOOPS_URL.'/modules/rw_banner/conta_click.php?id='.$ban->getCodigo().'" target="'.$ban->getTarget().'">';
          if (stristr($ban->getGrafico(), '.swf')) {
            ...
            .'<param name=movie value="'.XOOPS_URL.'/modules/rw_banner/images/rwbanner.swf">'
            .'<param name=quality value=high>'
            .'<PARAM NAME=FlashVars VALUE="alt='.$ban->getAltura().'&larg='.$ban->getLargura().'&fps='.$fps.'&banner='.$ban->getGrafico().'&id='.$ban->getCodigo().'&url='.XOOPS_URL.'/modules/rw_banner&target='.$ban->getTarget().'">'
            .'<embed src="'.XOOPS_URL.'/modules/rw_banner/images/rwbanner.swf" FlashVars="alt='.$ban->getAltura().'&larg='.$ban->getLargura().'&fps='.$fps.'&banner='.$ban->getGrafico().'&id='.$ban->getCodigo().'&url='.XOOPS_URL.'/modules/rw_banner&target='.$ban->getTarget().'" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash"; type="application/x-shockwave-flash" width="'.$ban->getLargura().'" height="'.$ban->getAltura().'">'
            .'</embed>'
            .'</object>';
          }else{
            if ($ban->getShowimg() == 1){
